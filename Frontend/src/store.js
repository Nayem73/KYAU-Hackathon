...
import {
  ...
  pictureSliderReducer,
} from "./reducers/pictureReducers";
...
import {
  addvertiseCreateReducer,
  addvertiseReducer,
} from "./reducers/addvertiseReducers";
import {
  noticeCreateReducer,
  noticeReducer,
} from "./reducers/addNoticeReducers";
import {
  employmentCreateReducer,
  employmentListReducer,
} from "./reducers/employmentReducers";
...
const reducer = combineReducers({
  ...
  addvertiseList: addvertiseReducer,
  addvertiseCreate: addvertiseCreateReducer,

  noticeList: noticeReducer,
  noticeCreate: noticeCreateReducer,

  employmentList: employmentListReducer,
  employmentCreate: employmentCreateReducer,
});
