                    ...
                    <tbody>
                        ...
                        {diseases.map(disease => (
                            <tr key={disease.id}>
                                ...
                                {/* <td><Link to={`/admin/picture/${disease.crop.title}/${disease.title}/${disease.id}/`}><i className="fa-solid fa-image"></i></Link></td> */}
                                ...
                                <td>
                                    ...
                                    <><button onClick={() => deleteHandler(disease.id)} className='btn ml-4'> <i className="fa-solid fa-check"></i> </button>
                                    <button onClick={() => deleteButtonHandler(disease.id)} className='btn ml-2'> <i className="fa-solid fa-xmark"></i></button></>
                                    :<></>
