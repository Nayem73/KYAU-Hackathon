...
const ProfileScreen = () => {
  ...
  const {
    loading: loadingSubscriptedUser,
    error: errorSubscriptedUser,
    success: successSubscriptedUser,
    subscription: subscriptedUser,
  } = subscriptionCheck;
      ...
      {loading ? (
        ...
        <div className="container px-5 py-10 mx-auto ">
          <div className="flex flex-wrap -m-4">
              ...
              <div className="h-full px-8 py-10 review">
                <div className="flex flex-col items-center mb-3">
                  <div className=" my-5 w-full inline-flex items-center justify-center flex-shrink-0 py-2 lg:h-10 mb-5 text-blue-500 bg-blue-100 rounded-full dark:bg-blue-500 dark:text-blue-100">
                    <h2 className="px-8 font-bold text-xl title-font">
                      Profile Info
                    </h2>
                  </div>
                  ...
                  <div className="flex-grow">
                    ...
                    {subscriptedUser !== undefined &&
                    subscriptedUser.is_subscribed ? (
                      <>
                        <p className="text-sm text-gray-500">
                          <strong>Account Statues : </strong> General
                        </p>
                        <p className="text-sm text-gray-500">
            ...
            {subscriptedUser !== undefined &&
            subscriptedUser.is_subscribed === false ? (
              <div className="p-4 w-full">
                <div className="h-full px-8 py-10 review">
                  <div className="flex flex-col items-center mb-3">
                    <div className=" my-5 w-full inline-flex items-center justify-center flex-shrink-0 py-2 lg:h-10 mb-5 text-blue-500 bg-blue-100 rounded-full dark:bg-blue-500 dark:text-blue-100">
                    ...
                    <div className="flex-grow">
                      ...
                      <p className="text-sm text-gray-500">
                        Turn your dreams into reality by becoming a gardener,
                        farmer, or agricultural enthusiast. Monitor and identify
                        common crop diseases with ease. Simply snap a picture,
                        and access insights that were once out of reach for both
                        hobbyists and full-timers alike. Unlock the potential
                        with an AI Search subscription today! Get unlimited
                        access for just Taka 500 !
                      </p>
                      <p className="text-sm text-gray-500">
                        <strong>Subscription Amount : </strong>
                        {subscriptedUser.amount} Taka
                      </p>
              ...
              <div className="h-full px-8 py-10 review">
                <div className="flex flex-col items-center mb-3">
                  <div className=" my-5 w-full inline-flex items-center justify-center flex-shrink-0 py-2 lg:h-10 mb-5 text-blue-500 bg-blue-100 rounded-full dark:bg-blue-500 dark:text-blue-100">
                    ...
                    <h2 className="lg:px-8 md:px-4 font-bold text-xl title-font">
                      Change Password
                    </h2>
                  </div>
                  <div className="flex-grow">
                    <FormContainer>
                      <div>
                        {errorPasswordChange && (
                          <Message message={errorPasswordChange} />
                        )}
