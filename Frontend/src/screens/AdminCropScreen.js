                        ...
                        {crops.map(crop => (
                            <tr key={crop.id}>
                                ...
                                <td className="text-right">
                                    ...
                                    <><button onClick={() => deleteHandler(crop.id)} className='btn ml-3'> <i className="fa-solid fa-check"></i> </button>
                                    <button onClick={() => deleteButtonHandler(crop.id)} className='btn ml-3'> <i className="fa-solid fa-xmark"></i></button></>
                                    :<></>

                                    }

                                    {(edit_crop_bool && (edit_crop_id ===crop.id )) ?
                                    <><button onClick={() => editHandler(crop.id)} className='btn ml-3'> <i className="fa-solid fa-check"></i> </button>
                                    <button onClick={() => editButtonHandler(crop.id)} className='btn ml-3'> <i className="fa-solid fa-xmark"></i></button></>
                                    :<></>
                                    }
