                        ...
                        {pictures.map(picture => (
                            <tr key={picture.id}>
                                ...
                                <td>
                                    ...
                                    <><button onClick={() => deleteHandler(picture.id)} className='btn ml-3'> <i className="fa-solid fa-check"></i> </button>
                                    <button onClick={() => deleteButtonHandler(picture.id)} className='btn ml-3'> <i className="fa-solid fa-xmark"></i></button></>
                                    :<></>

                                    }

                                    {(edit_picture_bool && (edit_picture_id ===picture.id )) ?
                                    <><button onClick={() => editHandler(picture.id)} className='btn ml-3'> <i className="fa-solid fa-check"></i> </button>
                                    <button onClick={() => editButtonHandler(picture.id)} className='btn ml-3'> <i className="fa-solid fa-xmark"></i></button></>
                                    :<></>
                                    }
