  ...
  return (
    <div>
      <div className="mt-5 flex flex-col w-full text-center">
        <h1 className="mb-6 text-2xl font-semibold tracking-widest text-black uppercase title-font">
          Reviews
        </h1>
      </div>
      <div className="container px-5 py-4 mx-auto">
        {loadingReviewList ? (
          ...
          <div className="flex justify-center">
            <Message message={errorReviewList} />{" "}
          </div>
        ) : (
          <div className="-m-4">
            {reviews.map((review) => (
                ...
                <div className="h-full lg:px-8 md:px-4 sm:px-4 py-10 lg:border-2 md:border-2 border-gray-200 rounded-lg dark:border-gray-800">
                  <div className="flex flex-col  mb-3">
                    <div className="inline-flex items-center justify-center flex-shrink-0 w-15 h-10 mb-5 py-2 text-blue-500 bg-blue-100 rounded-full dark:bg-blue-500 dark:text-blue-100">
                      ...
                      <h2 className="lg:px-8 md:px-4  sm:px-2 font-bold text-xl title-font">
                        {review.userName}
                      </h2>
                    </div>
                    ...
                    <div
                      className="flex-grow  rounded-lg dark:border-gray-800 
                  ...
                  <div className="flex justify-center">
                    {userInfo && userInfo.username === review.userName && (
                      <button
                        className="inline-flex px-4 py-2 text-base font-semibold text-white transition duration-500 ease-in-out transform bg-blue-500 border-blue-500 rounded-lg hover:bg-blue-700 hover:border-blue-700 focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2"
                        onClick={() => updateHandler(review.reviewId)}
                      >
                        Edit
                      </button>
                    )}
                    {userInfo &&
                      (userInfo.username === review.userName ||
                        ...
                        <button
                          className="inline-flex px-4 py-2 ml-4 text-base font-semibold text-white transition duration-500 ease-in-out transform bg-red-500 border-red-500 rounded-lg hover:bg-red-700 hover:border-red-700 focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2"
            ...
            <div className="h-full px-8 py-10 review">
              <div className="flex flex-col items-center mb-3">
                ...
                <div className="flex justify-center mb-5 mt-5">
                  ...
                  {successReviewCreate && (
                    <SuccessMessage message={"Review is added successfully"} />
                  )}

                  {errorReviewUpdate && <Message message={errorReviewUpdate} />}
                  {successReviewUpdate && (
                    <SuccessMessage message={"Review is updated"} />
                  )}
                </div>
                ...
                {userInfo ? (
                        ...
                        {editingReview ? (
                          <>
                            ...
                            <div
                              ...
                              className=" btn btn-primary w-24 mx-5"
                            >
                              Cancle
                            </div>
                          </>
                  ...
                  <>
                    <div className="flex justify-center m-10">
                      <div
                        className="flex-grow  rounded-lg dark:border-red-800 
            dark:bg-red-100 p-8
