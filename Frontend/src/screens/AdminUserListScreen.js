                    ...
                    <tbody>
                            ...
                            {users.map(user => (
                                <tr key={user.id}>
                                    ...
                                    :<>
                                    {(edit_user_bool && (edit_user_id === user.id )) ?
                                    <><button onClick={() => editHandler(user.id)} className='btn ml-3'> <i className="fa-solid fa-check"></i> </button>
                                    <button onClick={() => editButtonHandler(user.id)} className='btn ml-3'> <i className="fa-solid fa-xmark"></i></button></>
                                    :<></>
                                    }
                                    </>}
                                    </td>
