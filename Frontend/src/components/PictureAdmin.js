                        ...
                        {pictures.map(picture => (
                            <tr key={picture.id}>
                                ...
                                <td className="text-right">
                                    ...
                                    <><button onClick={() => deleteHandler(picture.id)} className='btn mx-3'> <i className="fa-solid fa-check"></i> </button>
                                    <button onClick={() => deleteButtonHandler(picture.id)} className='btn mx-3'> <i className="fa-solid fa-x"></i></button></>
                                    :<></>

                                    }

                                    {(edit_picture_bool && (edit_picture_id ===picture.id )) ?
                                    <><button onClick={() => editHandler(picture.id)} className='btn mx-3'> <i className="fa-solid fa-check"></i> </button>
                                    <button onClick={() => editButtonHandler(picture.id)} className='btn mx-3'> <i className="fa-solid fa-x"></i></button></>
                                    :<></>
                                    }
                                    ...
                                    <button onClick={() => handleCopyClick(picture.id, picture.img)} className='btn mx-3'> <i className="fa-solid fa-copy"></i> </button>
